...
func (a *Adapter) createAlert(ctx context.Context, msg notifications.CommsMessage) notifications.CommsDeliveryResult {
	alert := opsgenieAlert{
		Message:     msg.Summary,
...
func (a *Adapter) closeAlert(ctx context.Context, msg notifications.CommsMessage) notifications.CommsDeliveryResult {
	if msg.DedupKey == "" {
...
func (a *Adapter) acknowledgeAlert(ctx context.Context, msg notifications.CommsMessage) notifications.CommsDeliveryResult {
	if msg.DedupKey == "" {
...
func (a *Adapter) doPost(ctx context.Context, url, msgID string, payload interface{}) notifications.CommsDeliveryResult {
