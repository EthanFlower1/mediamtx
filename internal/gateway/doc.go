// Package gateway implements the Gateway role: an authenticated, Raikada-fronted
...
//     and rewrites the request to point at the upstream Raikada path on the
//     resolved Recorder.
//  5. A co-resident Raikada sidecar (managed via internal/shared/sidecar)
...
//
// KAI-258 (LAN-vs-Gateway routing) and KAI-260 (Raikada auth webhook
