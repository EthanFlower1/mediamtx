...
export default function ConfirmDialog({
  ...
  return (
    ...
    >
      ...
      >
        <h3 id="confirm-dialog-title" className="text-lg font-semibold text-nvr-text-primary mb-2">{title}</h3>
        <p id="confirm-dialog-message" className="text-sm text-nvr-text-secondary mb-6">{message}</p>
